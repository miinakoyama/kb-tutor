    ...
    <div className="flex-shrink-0 rounded-xl border border-[#16a34a]/30 bg-white px-4 sm:px-5 py-4 sm:py-5 shadow-sm">
      {isReviewing && (
        <button
          ...
          className="inline-flex items-center gap-1.5 text-sm font-medium mb-3 transition-colors text-primary hover:text-primary-hover focus-visible:text-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 rounded"
        >
...
function NavigationControls({
  ...
  const isNextDisabled =
    !isReviewing && currentIndex === totalQuestions - 1 && !allAnswered;
  ...
  return (
    <div className="flex-shrink-0 pt-4">
      <div className="flex items-center justify-between gap-2 sm:gap-4 bg-sand-beige rounded-xl p-3 border border-[#16a34a]/20">
          ...
          {sessionQuestions.map((_, index) => {
            ...
            return (
              <button
                ...
                className="w-8 h-8 sm:w-9 sm:h-9 rounded-full text-xs sm:text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-1"
                style={{
        ...
        <button
          onClick={isReviewing ? onBackToResults : onNext}
          disabled={isNextDisabled}
          className="inline-flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2.5 min-h-[44px] rounded-lg text-white font-medium disabled:opacity-40 disabled:cursor-not-allowed transition-colors bg-primary hover:bg-primary-hover focus-visible:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-1"
        >
    ...
    <div className="h-full overflow-y-auto">
      ...
      >
        ...
        <div className="flex gap-3 justify-center">
          <button
            onClick={onRetry}
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 min-h-[44px] rounded-lg text-white font-medium transition-colors bg-primary hover:bg-primary-hover focus-visible:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2"
          >
