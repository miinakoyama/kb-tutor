    ...
    >
      ...
      >
        ...
        <textarea
          ...
          rows={3}
          className="mt-1 w-full resize-none rounded-xl border border-[color:var(--assignment-panel-border)] bg-white/70 px-3 py-2 text-[13px] text-[color:var(--foreground)] focus:outline-none focus:ring-2 focus:ring-emerald-300"
        />
